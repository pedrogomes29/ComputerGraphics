...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.unitCube, this.cylinder,this.prism];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram': 3,'Unit Cube':4, 'Cylinder':5,'Prism':6};
    ...
    initMaterials() {
        ...
        const [r,g,b,alfa] = this.hexToRgbA("#855E42")

        this.woodMaterial = new CGFappearance(this);
        this.woodMaterial.setAmbient(0.0, 0.0, 0.0, 1.0);
        this.woodMaterial.setDiffuse(r,g,b,alfa);
        this.woodMaterial.setSpecular(0.1*r, 0.1*g, 0.1*b, 1.0);
