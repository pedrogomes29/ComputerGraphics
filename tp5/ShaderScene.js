...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/blueyellow.vert", "shaders/blueyellow_sepia.frag"),
		...
		this.testShaders[11].setUniformsValues({ waterTexture: 2 });
	...
	update(t) {
		...
		// only shader 9 is using time factor
